...
struct ItemTag {};
using Store = nc::PerfectHashStore<uint32_t, uint8_t, ItemTag>;
using Set = nc::PerfectHashSet<uint8_t, ItemTag>;
using Map = nc::PerfectHashMap<uint8_t, ItemTag, std::string>;
